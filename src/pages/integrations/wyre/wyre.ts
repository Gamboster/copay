...
export class WyrePage {
  ...
  private init(): void {
    ...
    this.wyreProvider.getStoredToken((at: string) => {
      ...
      this.wyreProvider.init((err, data) => {
          ...
          if (err) {
            ...
            if (err == 'unverified_account') {
              ...
              this.popupProvider
                ...
                .then(() => {
                  this.wyreProvider.logout(this.accessToken);
        ...
        this.wyreProvider.getWyre((err, ss) => {
          this.loading = false;
  ...
  //   const modal = this.modalCtrl.create(WyreDetailsPage, { ssData });
  ...
  public openAuthenticateWindow(): void {
    ...
    const oauthUrl = this.wyreProvider.getOauthCodeUrl();
